  ...
  render() {
    return (
      <div id="drum-machine">
        ...
        <button onClick={this.handleClick} className="drum-pad" id="q">
          ...
          Q</button>
        <button onClick={this.handleClick} className="drum-pad" id="w">
        ...
        <button onClick={this.handleClick} className="drum-pad" id="e">
        ...
        <button onClick={this.handleClick} className="drum-pad" id="a">
        ...
        <button onClick={this.handleClick} className="drum-pad" id="s">
        ...
        <button onClick={this.handleClick} className="drum-pad" id="d">
        ...
        <button onClick={this.handleClick} className="drum-pad" id="z">
        ...
        <button onClick={this.handleClick} className="drum-pad" id="x">
        ...
        <button onClick={this.handleClick} className="drum-pad" id="c">
